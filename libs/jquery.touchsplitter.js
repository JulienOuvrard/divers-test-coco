  ...
  (function(mod) {
    ...
    return TouchSplitter = (function() {
      function TouchSplitter(element, options) {
        ...
        firstdiv = this.element.find(">"+options.container+":first");
      ...
      TouchSplitter.prototype.getFirst = function() {
		return this.element.find(">"+this.options.container+":first");
      };

      TouchSplitter.prototype.getSecond = function() {
		return this.element.find(">"+this.options.container+":last");
